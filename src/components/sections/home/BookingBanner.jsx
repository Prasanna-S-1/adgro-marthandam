    ...
    <section className="relative w-full py-12 lg:py-24 bg-white">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <motion.div 
          ...
          className="relative bg-brand-dark rounded-[2rem] overflow-hidden shadow-2xl p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-10"
        >
          
          {/* --- DECORATIVE BACKGROUND ELEMENTS --- */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-brand-red/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 z-0" />
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-brand-gold/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4 z-0" />
          {/* Subtle Grid overlay for that medical tech feel */}
          ...
          <div className="relative z-10 w-full lg:w-3/5 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="hidden lg:block w-8 h-[2px] bg-brand-gold" />
          ...
          <div className="relative z-10 w-full lg:w-2/5 flex flex-col sm:flex-row lg:flex-col items-center justify-center lg:justify-end lg:items-end gap-6">
            ...
            >
              <div className="w-14 h-14 rounded-full border border-white/20 bg-white/5 backdrop-blur-md flex items-center justify-center group-hover:bg-brand-red group-hover:border-brand-red transition-all duration-300 shadow-clinical">
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="text-white font-medical font-bold text-xl md:text-2xl group-hover:text-brand-red transition-colors duration-300">
                  {siteConfig.phone}
                </span>
              </div>
            </a>
            ...
            <a 
              href="#book" 
              className="btn-premium w-full sm:w-auto bg-white text-brand-dark border-white hover:bg-brand-red hover:text-white hover:border-brand-red flex items-center justify-center gap-3 py-4 px-8 shadow-xl"
            >
