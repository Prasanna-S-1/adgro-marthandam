...
// --- DATA ARCHITECTURE ---
// We keep the data inside the file for easy editing. 
// Adding a new process later is as simple as adding a new object to this array.
const processData = [
  {
    id: "hair-process",
    title: "Hair Restoration Process",
    // Temporary clinical hair treatment image
  ...
  },
  {
    ...
    // Temporary clinical skin treatment image
        ...
        {processData.map((process, index) => {
          ...
          return (
            ...
            >
              ...
              {/* --- IMAGE COLUMN WITH ELITE OFFSET EFFECT --- */}
              <motion.div 
              ...
              >
                <div className="relative w-[90%] md:w-[80%] lg:w-[90%] mx-auto aspect-square lg:aspect-[4/3] z-10">
                  {/* The exact offset gray background square seen in your screenshots */}
                  <div className="absolute top-8 -left-8 md:-left-12 w-full h-full bg-[#f4f4f6] rounded-2xl z-0 transition-transform duration-700 hover:-translate-x-2 hover:translate-y-2" />
                  
                  {/* Main Image */}
                  <img 
                    src={process.image} 
                    alt={process.title} 
                    className="absolute inset-0 w-full h-full object-cover rounded-xl shadow-premium z-10"
                  />
                </div>
              </motion.div>
              ...
              <div className="w-full lg:w-1/2 flex flex-col justify-center">
                ...
                >
                  ...
                  <div className="w-16 h-[3px] bg-brand-red mb-12" />
                </motion.div>
                ...
                >
                  {process.steps.map((step, stepIndex) => (
                    ...
                    >
                      {/* The exact Red "Bullseye" Icon from your screenshot */}
                      <div className="mt-1 flex-shrink-0">
                        <div className="w-[18px] h-[18px] rounded-full border-[5px] border-brand-red bg-white shadow-sm group-hover:scale-110 transition-transform duration-300" />
                      </div>
