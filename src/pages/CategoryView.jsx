...
const CategoryView = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] pb-32 font-sans">
      ...
      <section className="relative bg-brand-dark text-white pt-48 pb-40 flex flex-col items-center justify-center overflow-hidden z-10 noise-overlay">
        ...
        {/* Glow orbs */}
        <div className="glow-orb-red w-[400px] h-[400px] -top-32 right-10 z-[1]" />
        <div className="glow-orb-gold w-[250px] h-[250px] bottom-0 -left-20 z-[1]" />

        <div className="relative z-20 flex flex-col items-center px-6 text-center max-w-4xl mx-auto">
          <span className="text-gradient-shimmer font-bold uppercase tracking-[0.4em] text-[10px] mb-6 animate-reveal-up">
            Clinical Portfolio
          </span>
          ...
          <div className="w-16 h-[2px] gradient-line mt-10 animate-reveal-up [animation-delay:300ms] rounded-full" />
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 relative z-20 -mt-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-12">
          ...
          {categoryData.subData.map((item, index) => (
            <div
              key={index}
              className="group relative bg-white/80 backdrop-blur-xl rounded-2xl shadow-glass hover:shadow-elevated transition-all duration-700 hover:-translate-y-2 overflow-hidden flex flex-col animate-reveal-up border border-white/50"
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                ...
                <div className="absolute bottom-0 left-0 w-full h-1 gradient-line z-20 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-700 ease-out"></div>
              </div>

              {/* CONTENT CONTAINER */}
              <div className="p-8 xl:p-10 flex flex-col flex-grow bg-white/50 backdrop-blur-sm relative">

                {/* Glassmorphic pill category badge */}
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-3 group-hover:text-brand-red transition-colors duration-500 bg-gray-50/80 backdrop-blur-sm rounded-full px-3 py-1 w-fit border border-gray-100">
                ...
                <div className="mt-auto pt-4">
                  <Link
                    ...
                    className="group relative flex items-center justify-between w-full px-6 py-4 border border-gray-100 rounded-xl overflow-hidden transition-all duration-500 hover:border-brand-red/30 hover:shadow-glow-red"
                  >
                    <div className="absolute inset-0 translate-x-[-101%] group-hover:translate-x-0 transition-transform duration-500 ease-out"
                      style={{ background: 'linear-gradient(135deg, var(--color-brand-red), var(--color-brand-red-dark))' }}></div>
